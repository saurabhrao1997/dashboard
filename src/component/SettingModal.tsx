...
//         // className="fixed bottom-0 right-6 z-50 bg-(--primary) text-white p-4 rounded-full shadow-lg"
//          className="fixed right-4 sm:right-6 top-1/2 -translate-y-1/2 bg-black text-white p-3 rounded-full shadow-lg hover:scale-105 transition"
//       >
//         ⚙️
//       </button>
...
//           <div
//             ref={ref}
//             className="w-[320px] h-full bg-[#1e293b] text-white p-6"
//           >
...
//                     primary === c ? "border-white scale-110" : "border-transparent"
//                   }`}
//                   style={{ background: c }}
//                 />
//               ))}
